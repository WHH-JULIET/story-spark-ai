    ...
    <div className="min-h-screen bg-white text-slate-900 dark:bg-[#0b1329] dark:text-white px-6 py-12 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        {blogPosts.map((post, index) => (
            <div key={index} className={`p-6 rounded-xl shadow-lg hover:scale-105 transition-transform duration-200 text-white ${
                 index === 0 ? "bg-gradient-to-br from-blue-600 to-indigo-700" :
                 index === 1 ?"bg-gradient-to-br from-violet-600 to-purple-700" :
